...
export interface Bindings {
  ...
  INTEGRATION_MICROSOFT_TEAMS_CLIENT_ID?: string;
  INTEGRATION_MICROSOFT_TEAMS_CLIENT_SECRET?: string;
  INTEGRATION_OFFICE_365_CLIENT_ID?: string;
  INTEGRATION_OFFICE_365_CLIENT_SECRET?: string;
