...
import { demoNodes, demoEdges, demoExecution, createDemoObjectUrl } from "@/data/homepage-demo";

export const DemoExecution = memo(() => {
  // Pre-populate outputs from execution data since readonly mode skips dynamic updates
  const processedNodes = useMemo(() => {
    const execMap = new Map(demoExecution.nodeExecutions.map(n => [n.nodeId, n]));
