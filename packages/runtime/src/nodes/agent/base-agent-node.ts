...
const AGENT_INPUTS: NodeType["inputs"] = [
  ...
  },
  {
    ...
    type: "number",
    description:
      "Maximum output tokens per LLM call. Thinking models spend part of this budget on reasoning. Leave empty for the default",
    required: false,
    hidden: true,
  },
  {
    ...
    try {
      ...
      const response = await stub.fetch("https://agent/start", {
        ...
        body: JSON.stringify({
          ...
          ...(max_tokens != null && { maxTokens: max_tokens }),
